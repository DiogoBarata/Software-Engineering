...
import ShowJustificationDialog from '@/views/teacher/questions/ShowJustificationDialog.vue';
  ...
  async created() {
    ...
    try {
      [this.topics, this.questions] = await Promise.all([
        ...
        RemoteServices.getApprovedQuestions()
      ]);
