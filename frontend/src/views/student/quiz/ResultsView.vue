  ...
  <div class="quiz-container" v-if="statementManager.correctAnswers.length > 0">
    ...
    <v-item-group>
      <v-btn
        ...
        >Clarification Request</v-btn
      >
      <v-btn
        v-bind:to="
          '/student/public/' +
            this.statementManager.statementQuiz.questions[questionOrder]
              .quizQuestionId
        "
        color="primary"
        dark
        data-cy="publicButton"
        >Public Clarification</v-btn
      >
    </v-item-group>
...
@Component({
  components: {
    ...
    'public-clarifications-view': PublicClarificationsView
  }
})
export default class ResultsView extends Vue {
  ...
  publicClarificationQuestion: boolean = false;
  ...
  publicClarification() {
    this.publicClarificationQuestion = true;
  }
