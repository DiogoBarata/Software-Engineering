    ...
    <v-app-bar color="primary" clipped-left>
      ...
      <v-toolbar-items class="hidden-sm-and-down" hide-details>
        ...
        <v-menu offset-y v-if="isTeacher && currentCourse" open-on-hover>
          ...
          <v-list dense>
            <v-list-item to="/management/questions" data-cy="teacherQuestions">
              <v-list-item-action>
            ...
            <v-list-item to="/management/submittedQuestions" data-cy="submittedQuestions">
              <v-list-item-action>
        ...
        <v-menu offset-y v-if="isStudent && currentCourse" open-on-hover>
          ...
          <v-list dense>
            <v-list-item to="/student/available-tournaments" data-cy="availableTournament">
              <v-list-item-action>
                <v-icon>assignment</v-icon>
              </v-list-item-action>
              <v-list-item-content>
            ...
            <v-list-item to="/student/create-tournaments" data-cy="createTournament">
              <v-list-item-action>
                <v-icon>create</v-icon>
              </v-list-item-action>
              <v-list-item-content>
            ...
            <v-list-item to="/student/my-tournaments" data-cy="mytournaments">
              <v-list-item-action>
                <v-icon>assignment</v-icon>
              </v-list-item-action>
              <v-list-item-content>
        ...
        <v-menu offset-y v-if="isStudent && currentCourse" open-on-hover>
          <template v-slot:activator="{ on }">
            <v-btn v-on="on" text dark data-cy="stats">
              Stats
          ...
          <v-list dense>
            ...
            <v-list-item to="/student/stats" data-cy="stats">
              <v-list-item-action>
                <v-icon>fas fa-user</v-icon>
              </v-list-item-action>
              <v-list-item-content>
            ...
            <v-list-item to="/student/dashboard" data-cy="dashboard">
              <v-list-item-action>
                <v-icon>fas fa-user</v-icon>
              </v-list-item-action>
              <v-list-item-content>
        ...
        <v-btn v-if="isLoggedIn" @click="logout" text dark data-cy="logoutButton">
          Logout
