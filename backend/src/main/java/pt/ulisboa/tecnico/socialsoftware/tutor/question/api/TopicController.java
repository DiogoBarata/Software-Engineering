...
public class TopicController {
    ...
    @PreAuthorize("hasRole('ROLE_DEMO_ADMIN') or hasRole('ROLE_ADMIN') or ((hasRole('ROLE_TEACHER') or hasRole('ROLE_STUDENT')) and hasPermission(#courseId, 'COURSE.ACCESS'))")
    ...
    @PreAuthorize("hasRole('ROLE_DEMO_ADMIN') or hasRole('ROLE_STUDENT') or hasRole('ROLE_DEMO_STUDENT') or hasRole('ROLE_ADMIN') or (hasRole('ROLE_TEACHER') and hasPermission(#topicId, 'TOPIC.ACCESS'))")
    ...
    @PreAuthorize("hasRole('ROLE_DEMO_ADMIN') or hasRole('ROLE_ADMIN') or (hasRole('ROLE_TEACHER') and hasPermission(#topicId, 'TOPIC.ACCESS'))")
