...
public class AnswerService {
    ...
    @Retryable(
            ...
            backoff = @Backoff(delay = 5000))
    @Transactional(isolation = Isolation.REPEATABLE_READ)
    public QuestionAnswer findById(Integer answerId){
        return questionAnswerRepository.findById(answerId).orElseThrow(() -> new TutorException(QUESTION_ANSWER_NOT_FOUND, answerId));
    }
