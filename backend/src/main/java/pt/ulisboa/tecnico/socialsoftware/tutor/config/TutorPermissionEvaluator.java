        ...
        if (targetDomainObject instanceof Integer) {
            ...
            switch (permissionValue) {
                ...
                case "QUESTION_ANSWER.ACCESS":
                    return userHasAnExecutionOfTheCourse(username, answerService.findQuestionAnswerCourse(id).getCourseId());
                case "TOPIC.ACCESS":
                ...
                case "CLARIFICATION.ACCESS":
                    return userHasAnExecutionOfTheCourse(username, clarificationService.findClarificationCourse(id).getCourseId());
