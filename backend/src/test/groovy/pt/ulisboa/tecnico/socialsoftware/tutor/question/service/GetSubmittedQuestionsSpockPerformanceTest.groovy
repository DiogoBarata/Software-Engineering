...
@DataJpaTest
class GetSubmittedQuestionsSpockPerformanceTest extends Specification {
    ...
    def "performance testing to get 1000 submitted questions"() {
        given: "a questionDto"
        ...
        when:
        1.upto(2, { questionService.findUserQuestions(course.getId(), USERNAME)})
