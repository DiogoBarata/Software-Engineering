...
@DataJpaTest
class ReviewAndCheckQuestionSpockPerformanceTest extends Specification {
    ...
    def "performance testing to change and check 1000 status"() {
        given: "a questionDto"
        ...
        1.upto(2, {
            ...
            questionService.questionSetStatus(questionDto.getId(), Question.Status.AVAILABLE)


        })

        when:
        1.upto(2, { questionService.findAvailableQuestions(course.getId())})
